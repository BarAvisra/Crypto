import { Box, Container, Heading, Input, IconButton, InputGroup, InputRightElement, Button } from '@chakra-ui/react';
            ...
            <Container maxWidth="container.lg" display="flex" alignItems="center" justifyContent="space-between">
                ...
                <Box display="flex" alignItems="center">
                    <InputGroup maxWidth="sm" mr={2}>
                        <Input type='text' textColor={'#718096'} placeholder="Search a coin" onChange={onSearchChange} />
                        <InputRightElement>
                            <IconButton
                                aria-label="Search"
